    ...
    return <section id={'webDev'}
        ...
        <div className={'flex flex-col md:flex-row items-center w-full gap-4'}>
            <div className={'grow flex flex-col gap-2 p-2 pl-0'}>
                ...
                <p>This website was created as a group project for the CS 2340 Objects and Design class at Georgia Tech. Its purpose is to
        ...
        <div className={'flex flex-col md:flex-row items-center w-full gap-4'}>
            ...
            <div className={'grow flex flex-col gap-2 p-2 pl-0'}>
                ...
                is intended to be a resource to help students with their college applications. I am currently working as
